...
file = File.open("app/assets/images/foodtourpic.jpg").read
experience.photo.attach(io: file, filename: "experience.jpg", content_type: "image/jpg")
experience.save
...
file = File.open("app/assets/images/tuscanpic.jpg").read
experience.photo.attach(io: file, filename: "experience.jpg", content_type: "image/jpg")
experience.save
...
file = File.open("app/assets/images/balicookingpic.jpg").read
experience.photo.attach(io: file, filename: "experience.jpg", content_type: "image/jpg")
experience.save
...
file = File.open("app/assets/images/maplesyruppic.jpg").read
experience.photo.attach(io: file, filename: "experience.jpg", content_type: "image/jpg")
experience.save
...
file = File.open("app/assets/images/flamencopic.jpg").read
experience.photo.attach(io: file, filename: "experience.jpg", content_type: "image/jpg")
experience.save
