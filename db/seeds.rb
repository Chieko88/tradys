...
experience = Experience.create!(name: "Jellied Eel Cooking Class", description: "Learn how to cook jellied eel, a traditional British dish at one of London's oldest fast food restaurants, F Cooke!", price: 6000, duration: 90 , address: "London, England", user: User.all.sample )
